...
function emor(m) {
	var src = (window.relEmo || "") +"emoticons/" + m.src;
	return "<span style='background-image:url(" + src + ")' class='emojicon-m'></span>";
}
...
function emopr(c) {
  ...
  var iTPL = ['<span style="background-image: url(' + (window.relEmo || '') +'emoticons/', '.png)" class="emojicon-m"></span>'];
...
window.emocache = function(){
    ...
    ifr.src = (window.relEmo || '') +'emoticons/cache.html';
    ifr.onload = function(){ifr.onload=null;ifr=null;}
